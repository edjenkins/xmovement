...
Route::group(['middleware' => ['web']], function () {
    ...
    // Proposal routes
    Route::get('/proposal/{idea}', 'ProposalController@index');
    Route::get('/proposal/view/{proposal}', 'ProposalController@view');
    Route::get('/proposal/add/{idea}', 'ProposalController@add');
    Route::post('/proposal/submit', 'ProposalController@submit');
    Route::delete('/proposal/destroy/{proposal}', 'ProposalController@destroy');
    ...
    Route::post('/vote/proposal', 'ProposalController@vote'); // Proposal
