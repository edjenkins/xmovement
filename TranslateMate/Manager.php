...
class Manager {
	...
	public function updateTranslation($updated_translation)
	{
		$translation = Translation::find($updated_translation["id"]);

		$translation->value = $updated_translation["value"];
