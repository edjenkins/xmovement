<form class="idea-form{{ $errors->isEmpty() ? '' : ' has-errors' }}" role="form" method="POST" action="{{ $editing ? '/design/poll/update' : '/design/poll/store' }}">
    {!! csrf_field() !!}
        ...
        <div class="form-page-content">
            ...
            <div class="form-group{{ $errors->has('locked') ? ' has-error' : '' }}">
                ...
                <div class="toggle-switch-wrapper">
                    ...
                    <label>{{ trans('xmovement_poll_form.locked_label') }}</label>
