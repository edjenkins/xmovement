	...
	<div class="col-md-6">
		...
		<div class="admin-tile">
			...
			<table class="table table-bordered">
				...
				<tr xm-config-setting xm-config="{type:'boolean',title:'Inspiration',key:'INSPIRATION_PHASE_ENABLED'}" xm-phase-timeline-ctrl="$ctrl"></tr>
				<tr xm-config-setting xm-config="{type:'boolean',title:'Creation',key:'CREATION_PHASE_ENABLED'}" xm-phase-timeline-ctrl="$ctrl"></tr>
		...
		<div class="admin-tile">
			...
			<table class="table table-bordered">
				...
				<tr xm-config-setting xm-config="{type:'boolean',title:'Shortlist',key:'SHORTLIST_ENABLED'}" xm-phase-timeline-ctrl="$ctrl"></tr>
			</table>
