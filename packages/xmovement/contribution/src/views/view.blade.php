...
@section('content')
	...
	@if ($proposal_mode)
		...
		@include('proposal/toolbar', ['design_task' => $design_task, 'proposal_task_index' => $proposal_task_index, 'proposal_tasks' => $proposal_tasks])
	    	...
	    	<div class="{{ (!$proposal_mode) ? 'col-md-9 col-md-pull-3' : 'col-md-10 col-md-offset-1' }}">
	    		...
	    		<div class="column main-column">
	    			...
	    			<div class="module-description">
	    				<a target="_self" href="{{ action('UserController@profile', $design_task->user) }}" title="{{ $design_task->user->name }}" class="module-description-user" style="background-image: url('{{ ResourceImage::getProfileImage($design_task->user, 'medium') }}')"></a>
